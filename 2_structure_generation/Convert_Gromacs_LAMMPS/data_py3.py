            ...
            for keyword in hkeywords:
                if keyword in self.headers:
                    if keyword == "xlo xhi" or keyword == "ylo yhi" or keyword == "zlo zhi":
                        ...
                        f.write(' '.join([ str(pair[0]),str(pair[1]),str(keyword) ]) +'\n')
                    elif keyword == "xy xz yz":
                        triple = self.headers[keyword]
                        f.write(' '.join([ str(triple[0]),str(triple[1]),str(triple[2]),str(keyword) ]) +'\n')
                    else:
                        f.write(' '.join([ str(self.headers[keyword]),str(keyword) ]) +'\n')
            for pair in skeywords:
                keyword = pair[0]
