...
def exec_job(job_args):
    ...
    pid, complex_epochs, init_shift, kick_center, kick_radius, kick_strength, kick_seeds, print_freq, job_list, cpu_count = job_args
    ...
    for job in job_list:
        ...
        for kick_seed in kick_seeds:
            ...
            os.chdir(cwd)
            try:
                main_minimize_complex(pid, convert_folder, complex_epochs, init_shift, kick_prop, print_freq)
            except:
